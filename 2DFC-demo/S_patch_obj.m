classdef S_patch_obj < Q_patch_obj
    ...
    methods
        ...
        function S_fcont_patch = FC(obj, C, n_r, d, A, Q, phi_normalization)
            ...
            S_fcont_patch = S_patch_obj(obj.M_p_general, obj.J_general, obj.eps_xi_eta, obj.eps_xy, obj.n_xi, C*n_r, obj.xi_start, obj.xi_end, obj.eta_start-C*h_eta, obj.eta_start, fcont(1:C*n_r+1, :), obj.h./n_r, obj.phi);
        end
    end
end
