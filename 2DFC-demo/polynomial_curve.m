...
curve_1 = Curve_obj(l_1, l_2, l_1_prime, l_2_prime, l_1_dprime, l_2_dprime, 0, 1/3, 1/3, 2/3, 2/3, h, []);
...
curve_2 = Curve_obj(l_1, l_2, l_1_prime, l_2_prime, l_1_dprime, l_2_dprime, 0, 1/3, 1/3, 2/3, 2/3, h, curve_1);
curve_1.next_curve = curve_2;


curve_seq = Curve_seq_obj(curve_1, 2);
