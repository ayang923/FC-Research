function [u_num_mat, R] = poisson_solver(curve_seq, f, u_boundary, h, G_cf, p, eps_xi_eta, eps_xy, d, C, n_r, A, Q, M)
...
uh = laplace_solver(R, curve_seq, u_m_up_boundary, G_cf, p, M, fc_err/10, eps_xi_eta, eps_xy, n_r);
