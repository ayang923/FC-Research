classdef C2_patch_obj < Q_patch_obj
    ...
    methods
        ...
        function [C2_fcont_patch_xi, C2_fcont_patch_eta, C2_fcont_patch_corner] = FC(obj, C, n_r, d, A, Q, phi_normalization)
            ...
            C2_fcont_patch_xi =  C2_patch_obj(obj.M_p, obj.J, obj.n_xi, C*n_r-1, obj.xi_start, obj.xi_end, obj.eta_start-(C)*h_eta, obj.eta_start, fcont(1:C*n_r, C*n_r+1:end), obj.phi);
            C2_fcont_patch_eta = C2_patch_obj(obj.M_p, obj.J, C*n_r-1, obj.n_eta, obj.xi_start-(C)*h_xi, obj.xi_start, obj.eta_start, obj.eta_end, fcont(C*n_r+1:end, 1:C*n_r), obj.phi);
            C2_fcont_patch_corner = C2_patch_obj(obj.M_p, obj.J, C*n_r-1, C*n_r-1, obj.xi_start-(C)*h_xi, obj.xi_start, obj.eta_start-C*h_eta, obj.eta_start, fcont(1:C*n_r, 1:C*n_r), obj.phi);
        end
